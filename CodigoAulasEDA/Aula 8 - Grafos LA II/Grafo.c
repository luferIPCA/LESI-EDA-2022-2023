...
//
//	while (aux) {
//		auxAdj.codDestino = codVerticeOrigem;
//		auxAdj.codOrigem = aux->cod;
//		auxAdj.weight = aux->dist;
...
////
////	Vertice* aux = g;
////	strcpy(fileNameAdja, strcat("Adj",fileName));
////	Vertice verticeFile;
////	while (aux) {
////		strcpy(verticeFile.cidade, aux->cidade);
////		verticeFile.cod = aux->cod;
////		frite(&verticeFile, 1, sizeof(verticeFile), fp);
////		//res = SaveAdj(aux->adjacentes, fileNameAdja, aux->cod);
////		if (res < 0) {					//erro ao gravar as adjacencias
////			return -2;
////		}
////		aux = aux->next;
////	}
